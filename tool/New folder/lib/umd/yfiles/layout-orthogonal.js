 ...
 **
 ***************************************************************************/
(function(r){(function(f) {if("function"===typeof define&&define.amd) {define(['./impl/lang','./impl/core-lib','./algorithms','./layout-tree','./impl/algorithms','./impl/layout-core','./impl/layout-tree','./impl/layout-orthogonal'],f);} else if("object"===typeof exports&&"undefined"!==typeof module&&"object"===typeof module.exports) {module.exports = f(require('./impl/lang'),require('./impl/core-lib'),require('./algorithms'),require('./layout-tree'),require('./impl/algorithms'),require('./impl/layout-core'),require('./impl/layout-tree'),require('./impl/layout-orthogonal'));} else {f(r.yfiles.lang,r.yfiles);}}(function(lang,yfiles) {return yfiles;}));})("undefined"!==typeof window?window:"undefined"!==typeof global?global:"undefined"!==typeof self?self:this);
